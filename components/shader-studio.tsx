...
const tabs: { id: Tab; label: string; icon: typeof SparklesIcon }[] = [
  { id: "style", label: "Style", icon: SparklesIcon }, { id: "palette", label: "Palette", icon: PaintBrush01Icon },
  { id: "surface", label: "Surface", icon: Layers01Icon }, { id: "motion", label: "Motion", icon: Activity01Icon },
